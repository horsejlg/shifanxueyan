...
<tr>
	...
	<td width="240" align="left"><input type="text" name="user.nickName" class="easyui-textbox" data-options="width:120,value:'${assistant.user.nickName}'" /></td>
...
<tr>
	...
	<td colspan=3><textarea rows="10" cols="75">${assistant.researchResults}</textarea></td>
</tr>
</table>
...
<div id='gradesBtn'>
	<input class="easyui-combobox" id="grades_grade" data-options="
...
$(function(){
	...
	$('#gradesList').datagrid({data:${jsonFormat(assistant.classess)}});
...
function saveStudent(){
	...
	var student = {id:"${assistant.id}"};
	student["user"]={id:"${assistant.user.id}"};
