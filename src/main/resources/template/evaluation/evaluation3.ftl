...
<tr>
	<th class="th">团结友善<br/>（15分）</th>
	<td colspan="6" align="left">1、坚持集体主义，个人利益要服从集体利益，得2分；<br>
2、积极树立团结意识，乐于助人，团结互助，服务他人，尊重他人与他人和谐相处，得2分；宿舍关系不和谐，宿舍全体成员减1分；申请调宿舍者减2分。<br>
3、爱护公物，节约水电，得2分；<br>
4、积极参加集体活动，具有集体荣誉感，得1分；未参加集体活动者，每次减1分；
<br>5、宿舍卫生合格，成员每人加4分，优秀宿舍每人次加2分，通报宿舍每人次扣0.5分；
<br>6、教室卫生合格，班级每人加4分，优秀班级每人次加1分，通报班级每人次扣0.5分
</td>
...
<tr>
	...
	<td colspan="6" align="left" style="padding: 0px;border-collapse: collapse;"><table width="100%" cellspacing="0" style="border: 0px;border-collapse: collapse;">
	<colgroup>
	<col width="80px">
	<col width="80px">
	<col ></colgroup>
						<tr>
							<td align="center">教育情怀<br>
（13分）
</td>
							<td colspan="2" >1、参加爱心社等教学支教活动，经审核后加2分；<br>
2、参加三下乡志愿服务活动，获得国家、省、校表彰的服务团队、每人次分别为10分、6分、3分；获国家、省、校表彰的先进个人，每人次分别为12分、8分、5分；获国家、省、校、系（院）奖励的社会实践调查报告，每人次分别为8分、6分、4分、2分。上述项目，按最高项计分，不重复加分。<br>
3、担任实习或者见习班主任，得2分；
							</td>
						</tr>
						<tr>
							<td rowspan="2" align="center">师德规范<br>
（2分）
</td>
							<td align="center">课程学习</td>
							<td >1、学习教育法律法规；<br>
2、认真学习全国教育大会精神；<br>
3、学习教师职业十项准则；
以上项目，加1分；
						...
						<tr>
							<td align="center">学分置换</td>
							<td >1、学习网络课程资源，根据学习时间置换学分（学习不少于5个学时）；<br>
2、认识50-60名老师，与他们交谈，交流经验；
以上项目可以置换1个学分，综合测评加1分；
</td>
						</tr>
					</table>
</td>
