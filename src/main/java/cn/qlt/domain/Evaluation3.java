 ...
 */
@Entity
@Table(name="evaluation3")
@DiscriminatorValue("3")
public class Evaluation3 extends Evaluation{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -5316616072345535898L;
	...
	public String toString() {
		return "Evaluation2 [baseEvaluationSorce=" + baseEvaluationSorce + ", baseEvaluationLevel="
				...
				+ ", baseRemark4=" + baseRemark4 + ", vetoSource=" + vetoSource + ", vetoContent=" + vetoContent
